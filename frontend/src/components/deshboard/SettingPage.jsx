...
const SettingsPage = () => {
  ...
  return (
    <>
      <Seo
        title="Settings – GenAi"
        description="Update your GenAi account settings, security options, and preferences."
        url={`${import.meta.env.WEBSITE_URL}/settings`}
        // noindex={true}
      />
