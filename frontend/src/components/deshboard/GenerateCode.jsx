  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-indigo-950 to-purple-950 text-gray-100 font-sans antialiased overflow-x-hidden">
      <header className="relative py-24 flex flex-col items-center justify-center text-center px-4 md:px-8">
        ...
        <div className="absolute top-1/2 right-1/4 w-72 h-72 bg-blue-700 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-1/4 left-1/2 w-72 h-72 bg-indigo-700 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob" style={{ animationDelay: '4s' }}></div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-2xl text-gray-300 mb-10 max-w-2xl mx-auto">
            Unleash the power of AI to generate beautiful, functional code and UI components in seconds. Your ideas, brought to life.
          </p>
            ...
            <div className="relative z-10 h-full w-full flex flex-col lg:flex-row gap-8">
              <div className="flex-1 bg-gray-900/70 backdrop-blur-md rounded-2xl p-6 flex flex-col border border-white/10 shadow-inner shadow-gray-800">
                <div className="flex-grow overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-purple-500 scrollbar-track-transparent">
                  <div className="mb-6">
                    <div className="text-purple-300 font-semibold mb-2">You:</div>
                    <p className="bg-purple-800/50 p-3 rounded-xl rounded-bl-none max-w-[85%] text-gray-100 shadow-md">
                      Generate a responsive React component for a user profile card with an avatar, name, title, and two action buttons.
                    </p>
                  </div>
                  <div>
                    <div className="text-blue-300 font-semibold mb-2">GenAI:</div>
...
export default UserProfileCard;`}
                ...
                <form className="mt-6 flex gap-3">
                  ...
                  />
                  <button type="submit" className="px-5 py-3 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl text-white font-semibold hover:from-purple-700 hover:to-blue-700 transition duration-300 shadow-md">
                    Send
                  </button>
                </form>
              </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 flex flex-col items-center text-center shadow-lg shadow-gray-900/30 transform hover:scale-105 transition duration-300">
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-gray-600 to-gray-700 text-xs font-bold uppercase rounded-full tracking-wider shadow-md text-gray-200">Starter</span>
              <h3 className="text-3xl font-bold text-gray-100 mt-6 mb-4">Free Plan</h3>
              ...
              <ul className="text-gray-300 text-left space-y-3 mb-8 w-full">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-400 mr-2" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
            ...
            <div className="relative bg-gradient-to-br from-purple-800/30 to-blue-800/30 backdrop-blur-xl border border-blue-500/50 rounded-2xl p-8 flex flex-col items-center text-center shadow-2xl shadow-blue-500/30 transform hover:scale-105 transition duration-300 ring-2 ring-blue-500">
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-blue-500 to-purple-500 text-xs font-bold uppercase rounded-full tracking-wider shadow-md text-white animate-pulse">Popular</span>
              <h3 className="text-3xl font-bold text-white mt-6 mb-4">Pro Plan</h3>
              <p className="text-5xl font-extrabold text-white mb-6">
            ...
            <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 flex flex-col items-center text-center shadow-lg shadow-gray-900/30 transform hover:scale-105 transition duration-300">
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-indigo-600 to-violet-700 text-xs font-bold uppercase rounded-full tracking-wider shadow-md text-white">Team</span>
              <h3 className="text-3xl font-bold text-gray-100 mt-6 mb-4">Team Plan</h3>
              <p className="text-5xl font-extrabold text-white mb-6">
