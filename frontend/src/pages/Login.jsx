  ...
  return (
    <>
      <Seo
        title={"Login – GenAi"}
        description={
          "Login to your GenAi account and access your AI-powered developer tools."
        }
        url={import.meta.env.WEBSITE_URL}
      />
      <div className=" flex px-4 items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
        {/* Card */}
        <motion.div
